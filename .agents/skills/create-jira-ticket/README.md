...
3. Drafts the description: a persona/goal/reason opening, max-5-bullet outcome-based acceptance criteria, and detailed implementation notes
...
| Section                  | Content                                                                                              |
| ------------------------ | ---------------------------------------------------------------------------------------------------- |
| **Opening paragraph**    | "As a [persona], I want [X] because [Y]" — no heading, just the sentence                             |
...
- **Persona/goal/reason is mandatory.** Every ticket opens with "As a X, I want Y because Z."
