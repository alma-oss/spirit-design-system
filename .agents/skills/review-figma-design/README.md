...
| **Specific checks**     | Page Section/Container structure, variant/enum completeness, Code Connect coverage, deprecated components, icon existence in repository, git/JIRA cross-reference                                    | Missing component instances, hard-coded values vs tokens, repeated sibling structures, variant drift                        |
