...
2. Surveys unstaged and staged changes (`git status`, `git diff`; `git-surgeon hunks` when available)
3. Groups hunks into logical, self-contained units — feature vs. tests vs. docs vs. unrelated fixes
