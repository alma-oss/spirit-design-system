...
export const MyComponent = () => (
  <>
    <Toggle id="toggle-default" label="Label" marginY="space-500" />
    <Toggle id="toggle-spread-before" label="Label" marginY="space-500" {...props} />
    <Toggle id="toggle-spread-after" marginY="space-500" {...props} label="Label" />
    ...
    <Stack hasSpacing={false}>
      <Toggle id="toggle-in-stack-without-spacing" label="Label" marginY="space-500" />
    </Stack>
