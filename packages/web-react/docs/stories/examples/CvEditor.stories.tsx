          ...
          >
            <Stack spacing="space-1000">
              ...
              <Card elementType="section" isBoxed>
                ...
                <CardBody>
                  <Heading elementType="h2" size="small" marginBottom="space-400" fontWeight="semibold">
                    Získejte nabídky bez hledání
                  </Heading>
                  {/* TODO: DS-2748 — Consider making Card more customizable.
              ...
              {/* TODO: DS-2753 — Consider removing the baked-in horizontal padding from NavigationItems.
              ...
              >
                ...
                {/* TODO: DS-2750 — Allow the `toolbar` pattern for Navigation
            ...
            <Stack spacing="space-1000">
              ...
              <Surface elementType="section" ariaLabelledby="cv-personal-details-heading">
                <Flex alignmentX="space-between" alignmentY="center" spacing="space-900">
                  ...
                  {/* TODO: DS-2751 — Allow the `menu` pattern for Dropdown
                  ...
                  >
                    {/* TODO: DS-2749 — Consider making Card declare a background color context
                ...
                <Stack elementType="dl" spacing="space-300">
                  ...
                  <Text elementType="dd" fontWeight="semibold">
                    Jirik Bárta
                  </Text>
              ...
              <Surface elementType="section" ariaLabelledby="cv-photo-heading">
                <Stack spacing="space-400">
                  <Heading id="cv-photo-heading" elementType="h2" size="small" fontWeight="semibold">
                    Fotka
                  </Heading>
                ...
                <FileUpload
                  ...
                  strings={{ label: { button: 'Procházet', upload: 'Nahrajte nebo přetáhněte soubor' } }}
                />
              </Surface>
