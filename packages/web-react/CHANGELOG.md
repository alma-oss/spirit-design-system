...
- **web-react:** Change package npm organization to alma-oss ([3d5e52e](https://github.com/lmc-eu/spirit-design-system/commit/3d5e52e)), closes [#DS-2173](https://github.com/lmc-eu/spirit-design-system/issues/DS-2173)
- **web-react:** Drop support for React v17 ([b32d128](https://github.com/lmc-eu/spirit-design-system/commit/b32d128))

**Note:** Version bump only for package @alma-oss/spirit-web-react

<a name="3.25.0"></a>

# [3.25.0](https://github.com/lmc-eu/spirit-design-system/compare/@lmc-eu/spirit-web-react@3.24.0...@lmc-eu/spirit-web-react@3.25.0) (2025-12-15)
...
- **web-react:** Automatic Icon size in Avatar [#DS-2274](https://github.com/lmc-eu/spirit-design-system/issues/DS-2274) ([a4ea50e](https://github.com/lmc-eu/spirit-design-system/commit/a4ea50e))
