...
type TestButtonProps<T extends React.ElementType = 'button'> = PolymorphicComponentProps<T, TestButtonBaseProps>;

const TestButtonInner = <T extends React.ElementType = 'button'>(props: TestButtonProps<T>, ref: PolymorphicRef<T>) => {
