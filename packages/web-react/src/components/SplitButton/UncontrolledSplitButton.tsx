  ...
  return (
    <SplitButton {...restProps} id={id} isDisabled={isDisabled}>
      <Button onClick={buttonOnClick}>
        {buttonIconName && <Icon name={buttonIconName} marginRight={!isButtonLabelHidden ? 'space-400' : undefined} />}
      ...
      >
        <DropdownTrigger elementType={Button}>
          ...
          <Icon name={dropdownTriggerIconName!} marginLeft={!isDropdownTriggerLabelHidden ? 'space-400' : undefined} />
        </DropdownTrigger>
