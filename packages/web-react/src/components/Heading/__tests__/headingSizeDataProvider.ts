const headingSizeDataProvider = [
  ...
  ['large', 'bold', 'typography-heading-large-bold'],
  ['xlarge', 'bold', 'typography-heading-xlarge-bold'],
  ['xsmall', 'semibold', 'typography-heading-xsmall-semibold'],
  ['small', 'semibold', 'typography-heading-small-semibold'],
  ['medium', 'semibold', 'typography-heading-medium-semibold'],
  ['large', 'semibold', 'typography-heading-large-semibold'],
  ['xlarge', 'semibold', 'typography-heading-xlarge-semibold'],
];
