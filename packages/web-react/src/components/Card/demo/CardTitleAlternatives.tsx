...
const CardTitleAlternatives = () => (
  <Grid cols={{ mobile: 1, tablet: 2, desktop: 3 }}>
    ...
    <Card isBoxed>
      <CardMedia isExpanded>{MEDIA_IMAGE}</CardMedia>
      <CardBody>
        <Text elementType="h4" size="large" fontWeight="regular" textColor="primary" marginBottom="space-500">
          <CardLink href="#">Card title</CardLink>
        </Text>
        <p>Card content. The whole card is clickable via the title link.</p>
      </CardBody>
    ...
    <Card isBoxed>
      <CardMedia isExpanded>{MEDIA_IMAGE}</CardMedia>
      <CardBody>
        <Heading elementType="h4" size="medium" fontWeight="bold" textColor="secondary" marginBottom="space-700">
          Card title
        </Heading>
        <p>Card content. The whole card is clickable via the title link.</p>
      </CardBody>
