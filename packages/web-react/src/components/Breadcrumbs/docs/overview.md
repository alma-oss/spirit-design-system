...
- For **primary navigation** (use [**Navigation**](/components/navigation) instead).

- To switch between **peer content sections** within the same page (use [**Tabs**](/components/tabs)).

- For **progressive disclosure of content** (use [**Accordion**](/components/accordion) or [**Collapse**](/components/collapse)).
