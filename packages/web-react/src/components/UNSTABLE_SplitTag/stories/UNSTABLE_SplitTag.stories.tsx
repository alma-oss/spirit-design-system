...
const meta: Meta<typeof UNSTABLE_SplitTag> = {
  ...
  argTypes: {
    color: {
      control: 'select',
      options: [...Object.values(TagColorsExtended), ...Object.values(EmotionColors), undefined],
      table: {
    ...
    size: {
      control: 'select',
      options: [...Object.values(SizesExtended), undefined],
      table: {
...
export const Playground: Story = {
  ...
  render: (args: React.ComponentProps<typeof UNSTABLE_SplitTag>) => (
    <SplitTagLocationRadius
      color={args.color as TagColor<void>}
      id="storybook-split-tag-location-radius"
