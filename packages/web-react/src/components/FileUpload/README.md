...
<Stack spacing="space-800">
  <FileUpload
    ...
    name="attachments"
    label="Label"
    strings={{ label: { upload: 'Upload your file(s)', dragAndDrop: 'or drag and drop here' } }}
...
| `inputDragAndDropText`   | `string`                                         | —        | ✕        | _Deprecated, use `strings.label.dragAndDrop`_                                                                                                                                                                                                                      |
| `inputRef`               | `MutableRefObject<HTMLInputElement>`             | —        | ✕        | Input element reference                                                                                                                                                                                                                                            |
| `inputUploadText`        | `string`                                         | —        | ✕        | _Deprecated, use `strings.label.upload`_                                                                                                                                                                                                                           |
...
+ <FileUpload strings={{ label: { button: 'Browse', upload: 'Upload', dragAndDrop: 'or drop here' } }} />
```
