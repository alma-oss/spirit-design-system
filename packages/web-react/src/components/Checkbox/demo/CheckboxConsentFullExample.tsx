...
const CheckboxConsentFullExample = () => {
  ...
  return (
    <>
      ...
      <Modal id="checkbox-terms-modal" isOpen={isTermsOpen} onClose={() => setTermsOpen(false)}>
        <ModalDialog>
      ...
      <Modal id="checkbox-privacy-modal" isOpen={isPrivacyOpen} onClose={() => setPrivacyOpen(false)}>
        <ModalDialog>
...
export default CheckboxConsentFullExample;
