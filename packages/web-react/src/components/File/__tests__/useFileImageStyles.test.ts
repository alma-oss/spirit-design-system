...
describe('useFileImageStyles', () => {
  it('uses the same crop scaling as File image preview styling for a square crop region', () => {
    ...
    // Square crop region uses scale 0.48 → 168×96 for 48px preview.
  ...
  it('scales portrait crop by crop width', () => {
