// url=<FIGMA_FILE_ID>?node-id=50583%3A1805
...
let template;
if (figma.selectedInstance.getPropertyValue('Action type') === 'Buttons') {
  template = {
    id: 'ActionGroup',
...
} else if (figma.selectedInstance.getPropertyValue('Action type') === 'Links') {
  template = {
    id: 'ActionGroup',
