...
describe('InputDetails', () => {
  stylePropsTest((props) => <InputDetails {...props}>Test content</InputDetails>);

  restPropsTest((props) => <InputDetails {...props}>Test content</InputDetails>, 'div');
