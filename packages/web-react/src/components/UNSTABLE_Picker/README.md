...
| `addButtonLabel`      | `string`                                                  | i18n `picker.add`                  | ✕        | _Deprecated, use `strings.ariaAdd`_                                                                                                                                                         |
| `closeButtonLabel`    | `string`                                                  | i18n `common.close`                | ✕        | _Deprecated, use `strings.ariaClose`_                                                                                                                                                       |
...
| `removeAllLabel`      | `string`                                                  | i18n `picker.removeAll`            | ✕        | _Deprecated, use `strings.ariaRemoveAll`_                                                                                                                                                   |
| `removeItemLabel`     | `string`                                                  | i18n `picker.removeItemLabel`      | ✕        | _Deprecated, use `strings.ariaRemoveItem`_                                                                                                                                                  |
...
| `selectionAriaLabel`  | `string`                                                  | i18n `picker.selectionAriaLabel`   | ✕        | _Deprecated, use `strings.ariaSelection`_                                                                                                                                                   |
...
| `strings`             | `UnstablePickerStrings`                                   | —                                  | ✕        | `TranslatableString` overrides for component copy; see [Deprecation Notice](#deprecation-notice)                                                                                            |
| `tagDescriptionText`  | `string`                                                  | i18n `picker.tagDescriptionText`   | ✕        | _Deprecated, use `strings.ariaTagDescription`_                                                                                                                                              |
