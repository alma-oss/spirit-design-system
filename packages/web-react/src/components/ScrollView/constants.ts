...
export const SCROLL_VIEW_CONTROLS_LABEL_HORIZONTAL_END = 'Scroll right';
export const SCROLL_VIEW_CONTROLS_LABEL_HORIZONTAL_START = 'Scroll left';
export const SCROLL_VIEW_CONTROLS_LABEL_VERTICAL_END = 'Scroll down';
export const SCROLL_VIEW_CONTROLS_LABEL_VERTICAL_START = 'Scroll up';
