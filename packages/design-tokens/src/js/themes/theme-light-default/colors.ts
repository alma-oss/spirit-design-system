...
export const accent01BackgroundBasic = '#d80090';
export const accent01BackgroundSubtle = '#fdf2f9';
export const accent01BorderBasic = '#d80090';
export const accent01BorderSubtle = '#f7cce9';
export const accent01ContentBasic = '#d80090';
export const accent01ContentSubtle = '#fbe5f4';
export const accent01StateActive = '#ad0073';
export const accent01StateDefault = '#d80090';
export const accent01StateHover = '#c30082';

export const accent02BackgroundBasic = '#7847ff';
export const accent02BackgroundSubtle = '#f8f6ff';
export const accent02BorderBasic = '#7847ff';
export const accent02BorderSubtle = '#e4daff';
export const accent02ContentBasic = '#6039cc';
export const accent02ContentSubtle = '#f1edff';
export const accent02StateActive = '#936cff';
...
export const backgroundPrimary = '#fdfdfc';
...
export const componentNavigationItemBackgroundStateActive = '#f1edff';
export const componentNavigationItemBackgroundStateDefault = '#fff0';
export const componentNavigationItemBackgroundStateHover = '#f8f6ff';
export const componentNavigationItemBackgroundStateSelected = '#f8f6ff';
export const componentNavigationItemStateActive = '#4e2ea6';
export const componentNavigationItemStateDefault = '#404040';
export const componentNavigationItemStateHover = '#6039cc';
export const componentNavigationItemStateSelected = '#6039cc';
export const componentNavigationItemStripeStateSelected = '#ffbe00';
export const componentNavigationItemStripeStateUnselected = '#e4daff';

export const componentPaginationSelectedBorder = '#7847ff';
export const componentPaginationSelectedContent = '#fdfdfc';
...
export const componentPaginationUnselectedStateDefault = '#fdfdfc';
export const componentPaginationUnselectedStateHover = '#f9f9f9';

export const componentPricingPlanHighlightedBackground = '#f2f7fd';
...
export const emotionDangerContentSubtle = '#fdfdfc';
...
export const emotionInformativeContentSubtle = '#fdfdfc';
...
export const emotionSuccessContentSubtle = '#fdfdfc';
...
export const formFieldFillBackgroundStateDefault = '#fdfdfc';
export const formFieldFillBackgroundStateHover = '#f4f4f4';
export const formFieldFillBorderStateActive = '#7847ff';
export const formFieldFillBorderStateDefault = '#7f7f7f';
export const formFieldFillBorderStateHover = '#535353';
...
export const formFieldOutlineBorderStateDefault = '#1a1b1b8c';
...
export const formFieldOutlinePlaceholder = '#666';
...
export const neutralContentSubtle = '#fdfdfc';
export const neutralStateActive = '#535353';
export const neutralStateDefault = '#202020';
export const neutralStateHover = '#404040';

export const selectedBackgroundBasic = '#7847ff';
export const selectedBackgroundSubtle = '#f1edff';
export const selectedBorderBasic = '#7847ff';
export const selectedBorderSubtle = '#f1edff';
export const selectedContentBasic = '#7847ff';
export const selectedContentSubtle = '#fdfdfc';
export const selectedStateActive = '#6039cc';
export const selectedStateDefault = '#7847ff';
export const selectedStateHover = '#6c40e5';

export const shadowShadow100Color01 = '#0000001a';
