...
⚠️ Spirit design tokens are captured from [Figma][spirit-figma] and generated by the Figma tokens exporter. DO NOT EDIT MANUALLY!
...
They are all managed in our [Figma][spirit-figma] and generated by `@alma-oss/spirit-figma-tokens-exporter`. The
Supernova exporter remains available until the next major release for parity and rollback.

⚠️ All content in `src` is generated from Figma and should not be edited manually.

To regenerate files, capture a snapshot with the local Figma plugin and run `yarn sync` in this package. See the
[Figma tokens exporter][figma-tokens-exporter].
...
[figma-tokens-exporter]: https://github.com/alma-oss/spirit-design-system/tree/main/exporters/figma-tokens
