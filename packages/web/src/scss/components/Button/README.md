...
Turn on the [`Button--symmetrical`](#symmetrical-button) modifier when you only need a compact, icon-only button:
...
Use the `Button--symmetrical` modifier to make the button have equal width and height.
...
You can define responsive symmetrical buttons using breakpoint-specific modifiers:

```html
<button type="button" class="Button Button--primary Button--medium Button--tablet--symmetrical">
  <!-- Symmetrical from tablet up -->
</button>
```

To turn off symmetrical from a specific breakpoint onwards, use the `--asymmetrical` suffix:

```html
<button type="button" class="Button Button--primary Button--medium Button--symmetrical Button--tablet--asymmetrical">
  <!-- Symmetrical on mobile only -->
</button>
```
...
- [`Button--symmetrical`](#symmetrical-button) modifier to make the button symmetrical when only the icon is visible
