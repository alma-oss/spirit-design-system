...
2. Add closing button using `ControlButton ControlButton--medium ControlButton--symmetrical dynamic-color-border dynamic-color-background-interactive accessibility-tap-target` classes.
...
<div class="Tooltip d-inline-block" data-spirit-element="tooltip">
  ...
  <div id="my-dismissible-tooltip" class="TooltipPopover TooltipPopover--dismissible color-scheme-on-neutral-basic">
    ...
    <button
      type="button"
      class="ControlButton ControlButton--medium ControlButton--symmetrical dynamic-color-border dynamic-color-background-interactive accessibility-tap-target"
