...
<div class="ModalHeader">
  ...
  <button
    type="button"
    class="ControlButton ControlButton--xlarge text-color-scheme dynamic-color-background-interactive accessibility-tap-target ControlButton--hasBackground dynamic-color-border ControlButton--symmetrical"
