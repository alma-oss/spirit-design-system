...
```html
<!-- Textarea -->
<textarea id="example-field" aria-describedby="example-counter-sr"></textarea>
<!-- Visible counter, hidden from screen readers -->
<div class="CharacterCounter" aria-hidden="true">0/200</div>
<!-- Screen-reader message, hidden from sighted users -->
<div id="example-counter-sr" class="accessibility-hidden">You can enter up to 200 characters</div>
```
