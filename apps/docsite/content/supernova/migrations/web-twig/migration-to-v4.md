...
sourceUrl: https://spirit.supernova-docs.io/latest/migrations/web-twig/migration-to-v4-zRBb1o4j-zRBb1o4j
sourcePath: /latest/migrations/web-twig/migration-to-v4-zRBb1o4j-zRBb1o4j
sourceSection: migrations
lastExtractedAt: 2026-04-22T22:32:38.604Z
---
...
> ℹ️ Don't forget to check the [migration guide of the _spirit-web_ package](https://github.com/alma-oss/spirit-design-system/blob/main/docs/migrations/web/migration-v3.md) for general changes in available feature flags, CSS, JavaScript plugins, and other changes that might affect your project.
...
- [Component Changes](#component-changes)
  ...
  - [Link: ThehasVisitedStyleAllowed Props](#link-the-hasvisitedstyleallowed-prop)
...
The isUnderlined prop was removed from the Link component therefore it is not available in the Toast component JS plugin. Use underlined instead.
