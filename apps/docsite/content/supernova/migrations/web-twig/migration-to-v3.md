...
sourceUrl: https://spirit.supernova-docs.io/latest/migrations/web-twig/migration-to-v3-rqitLM4p
sourcePath: /latest/migrations/web-twig/migration-to-v3-rqitLM4p
sourceSection: migrations
lastExtractedAt: 2026-04-22T22:32:38.741Z
---
...
> ℹ️ Don't forget to check the [migration guide of the _spirit-web_ package](https://github.com/alma-oss/spirit-design-system/blob/main/docs/migrations/web/migration-v2.md) for general changes in available feature flags, CSS, JavaScript plugins, and other changes that might affect your project.
...
See [Dropdown: Placement Control](#dropdown-placement-control) and [Tooltip: Placement Control](#tooltip-placement-control) for more details.
...
In case you need to use the component as an information that requires the user's immediate attention, you can use role="alert" as an [additional attribute](https://github.com/alma-oss/spirit-design-system/blob/main/packages/web-twig/README.md#additional-attributes).
...
The reason for this change is to avoid confusion with the [target attribute](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#target) of the anchor tag.
...
👉 See [Tooltip documentation](https://github.com/alma-oss/spirit-design-system/blob/main/packages/web-twig/src/Resources/components/Tooltip/README.md) for more details and examples.
...
As a result, the enableControlledPlacement prop is no longer mandatory for the TooltipPopover component, as all Tooltips now are controlled by Floating UI.
...
Tooltip props enableFlipping, enableFlippingCrossAxis, enableShifting, and enableSizing are now turned on by default. You can turn them off by setting them to false.
