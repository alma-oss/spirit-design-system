...
sourceUrl: https://spirit.supernova-docs.io/latest/migrations/design-tokens/migration-to-v4-gdoCuazi
sourcePath: /latest/migrations/design-tokens/migration-to-v4-gdoCuazi
sourceSection: migrations
lastExtractedAt: 2026-04-22T22:32:37.332Z
---
...
> ℹ️ Don't forget to also update the [migration guide of the _spirit-web_ package](https://github.com/alma-oss/spirit-design-system/blob/main/docs/migrations/web/migration-v4.md) and [migration guide of the _spirit-web-react_ package](https://github.com/alma-oss/spirit-design-system/blob/main/docs/migrations/web-react/migration-v4.md) for related changes.
