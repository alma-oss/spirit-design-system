...
└── [CharacterCounter](/components/character-counter) — optional
...
- For **short, single-line inputs** (e.g., names, email addresses) – use [**Text Field**](/components/text-field).

- For **structured inputs** (e.g., numbers, dates, emails) – use **Text Field type number** or specialized input.

- When the user should pick from a **predefined set of choices** – use [**Select**](/components/select)**,** [**Radio**](/components/radio)**, or** [**Checkbox**](/components/checkbox).
