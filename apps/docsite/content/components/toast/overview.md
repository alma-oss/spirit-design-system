...
- For **context-specific guidance or validation** – use [**Alert**](/components/alert) instead.
...
- For subtle hints – use [**Tooltip**](/components/tooltip) or **inline help**.
