...
- For **switching between related content areas** on the same page – use [**Tabs**](/components/tabs).

- For **site/app navigation** between sections – use [**Navigation**](/components/navigation) (menus, header, sidebar).
