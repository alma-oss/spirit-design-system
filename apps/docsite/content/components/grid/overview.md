...
- For **single-row or inline alignment** of elements – use [**Flex**](/components/flex).

- For **simple spacing adjustments** – use spacing utilities instead.

- For **uniform content blocks** where alignment matters as much as spacing – use **[Matrix](/components/matrix)**.

- For **component grouping** (buttons, tags, inputs) where alignment is simple – use [**Action Group**](/components/action-group) or [**Stack**](/components/stack).
