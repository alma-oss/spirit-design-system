...
- For **larger or more complex content** that requires more space or persistence – use [**Drawer**](/components/drawer).

- For **disruptive, task-focused content** that requires user action before continuing – use [**Modal**](/components/modal).

- For **temporary global notifications** that appear above all content – use [**Toast**](/components/toast).

- For selecting from **many options** you can use the component **[Select](/components/select)** instead
