...
- The choice is **binary or tiny** (e.g., one add-on)– a **single** [**Card**](/components/card) or inline [**Action Group**](/components/action-group) may suffice.

- The purchase requires **multi-step configuration** – use [**Modal**](/components/modal)**,** [**Drawer**](/components/drawer) flow or a dedicated **checkout**.
